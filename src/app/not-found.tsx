...
import { FaCarrot, FaCartShopping, FaSeedling } from "react-icons/fa6";
...
export default function NotFound() {
  return (
    <section className="min-h-screen bg-[#fafbfc] flex items-center justify-center px-4 py-16 relative overflow-hidden">
      <div className=" absolute inset-0 overflow-hidden">
        <div className=" absolute top-[10%] left-[5%] text-primary-200 text-4xl animate-bounce">
          <FaAppleAlt />
        </div>
        <div className=" absolute top-[20%] right-[10%] text-primary-200 text-3xl animate-bounce">
          <FaCarrot />
        </div>
        <div className=" absolute bottom-[25%] left-[8%] text-primary-200 text-3xl animate-bounce">
          <FaLemon />
        </div>
        <div className=" absolute bottom-[15%] right-[15%] text-primary-200 text-4xl animate-bounce">
          <FaSeedling />
        </div>
        <div className=" absolute top-[50%] left-[15%] text-primary-100 text-2xl animate-bounce">
          <FaAppleAlt />
        </div>
        <div className=" absolute top-[40%] right-[5%] text-primary-100 text-2xl animate-bounce">
          <FaCarrot />
        </div>
      ...
      <div className=" relative z-10 max-w-xl w-full">
        ...
        <div className=" flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <Link
            ...
            href="/"
          >
            <House className="size-4.5 mb-0.5 group-hover:scale-110 transition-transform duration-300" />
            Go to Homepage
          </Link>
        ...
        <div className=" bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
          ...
          <div className=" flex flex-wrap items-center justify-center gap-3">
            {links.map((link) => (
              <Link
                key={link.href}
                className={`px-5 py-2.5 rounded-xl ${link.title === "All Products" ? "bg-primary-50 text-primary-700" : "bg-gray-100 text-gray-700"} font-semibold text-sm hover:bg-primary-100 transition-colors`}
                href={link.href}
              >
                {link.title}
              </Link>
