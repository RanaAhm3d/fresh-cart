...
import { FaEnvelope, FaGooglePlay, FaTruck } from "react-icons/fa";
import { FaArrowRightLong, FaLeaf, FaTag } from "react-icons/fa6";
...
export default function GetUpdates() {
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      className="py-16 bg-linear-to-b from-white to-gray-50 container mx-auto px-8"
    >
      <div className="relative bg-linear-to-br from-emerald-50 via-white to-teal-50 rounded-[40px] border border-emerald-100/50 shadow-2xl shadow-emerald-500/10 overflow-hidden">
