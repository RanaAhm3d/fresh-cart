      ...
      <div className="flex flex-col lg:flex-row gap-8 animate-pulse">
        <div className="lg:w-1/2">
          ...
          <div className="flex gap-2 mt-4">
            <div className="bg-gray-200 rounded h-20 w-20"></div>
            <div className="bg-gray-200 rounded h-20 w-20"></div>
            <div className="bg-gray-200 rounded h-20 w-20"></div>
            <div className="bg-gray-200 rounded h-20 w-20"></div>
          </div>
        ...
        <div className="lg:w-1/2">
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="bg-gray-200 h-10 w-1/3 rounded mb-6"></div>
            <div className="bg-gray-200 h-24 w-full rounded mb-6"></div>
            <div className="flex gap-4">
              <div className="bg-gray-200 h-14 flex-1 rounded-xl"></div>
              <div className="bg-gray-200 h-14 flex-1 rounded-xl"></div>
            </div>
          </div>
        </div>
